<x-app-layout>
<div class="flex bg-gradient-to-br from-blue-100 to-blue-50 pt-6 px-8 pb-18 min-h-[91vh]">
    ...
    <div class="flex-1 flex flex-col">
        ...
        <main>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <!-- Create AI Interview -->
                <a href="{{ route('interview.create') }}" class="flex items-center bg-white p-6 rounded-xl shadow-xl hover:shadow-2xl transform hover:scale-[1.02] transition-all duration-300">
                    <div class="w-14 h-14 bg-indigo-100 text-indigo-600 rounded-lg flex items-center justify-center mr-5">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 10l5-3v10l-5-3v2a2 2 0 01-2 2H5a2 2 0 01-2-2V9a2 2 0 012-2h8a2 2 0 012 2v2z" />
                        </svg>
                    </div>
                    <div>
                ...
                <a href="#" class="flex items-center bg-white p-6 rounded-xl shadow-xl hover:shadow-2xl transform hover:scale-[1.02] transition-all duration-300">
                    <div class="w-14 h-14 bg-indigo-100 text-indigo-600 rounded-lg flex items-center justify-center mr-5">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 5a2 2 0 012-2h1.28a1 1 0 01.95.68l1.32 3.95a1 1 0 01-.27 1.09l-1.24 1.24a16 16 0 006.59 6.59l1.24-1.24a1 1 0 011.09-.27l3.95 1.32a1 1 0 01.68.95V19a2 2 0 01-2 2h-1c-9.39 0-17-7.61-17-17V5z" />
                        </svg>
                    </div>
                    <div>
