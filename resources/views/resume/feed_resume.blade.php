<x-app-layout>
  <div class="flex bg-gradient-to-br from-blue-100 to-blue-50 pt-6 px-4 md:px-8 min-h-[91vh]">
              ...
              <table class="w-full border-collapse">
                ...
                <tbody class="divide-y divide-gray-200 text-gray-800">
                  @foreach($interviews as $job)
                    <tr class="hover:bg-indigo-50 transition duration-300 ease-in-out transform "
                      data-job="{{ $job->job_description }}">
                      <td class="px-6 py-4">
                        <span
                      ...
                      <td class="px-6 py-4 text-center">
                        <div class="flex items-center justify-center gap-3">
                          <!-- File Input -->
                          <label
                            class="cursor-pointer bg-gradient-to-r from-gray-100 to-gray-200 px-4 py-2 rounded-xl border border-gray-300 text-sm text-gray-700 hover:from-indigo-50 hover:to-indigo-100 hover:border-indigo-400 transition-all shadow-sm">
                          ...
                          <!-- Compare Button -->
                          <button type="button"
                            class="send-btn hidden px-4 py-2 bg-gradient-to-r from-indigo-600 to-blue-600 text-white text-sm rounded-xl shadow-md hover:shadow-lg hover:from-indigo-700 hover:to-blue-700 transition-all">
                            ⚡ Compare
                          </button>
                        </div>
