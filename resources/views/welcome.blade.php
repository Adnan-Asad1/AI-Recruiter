<x-app-layout>
  ...
  <section class="bg-gradient-to-br from-indigo-100 to-white flex min-h-[85vh] items-center overflow-x-hidden">

    <div class="max-w-7x3 mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-6 md:gap-12 items-center">

      <!-- 🔸 Left Content -->
      <div class="space-y-6 opacity-0 translate-x-[-40px] animate-fade-in-left">
      ...
      <!-- 🔸 Right Image -->
      <div class="flex justify-center items-center opacity-0 translate-x-[40px] animate-fade-in-right">
        <img src="{{ asset('AI.jpeg') }}" alt="AI Interview Illustration"
  ...
  <section id="features" class="py-20 bg-white mt-12 mb-12">
    <div class="max-w-5xl mx-auto px-6">
      ...
      <!-- 🔹 Animated Heading -->
      <h1 class="text-3xl font-bold text-center text-gray-900 mb-2" data-aos="fade-up" data-aos-duration="700">
        Automate your Hiring Process
      </h1>

      <!-- 🔹 Animated Subheading -->
      <span class="block text-center text-gray-600 mb-12 text-sm md:text-base" data-aos="fade-up" data-aos-delay="100"
    ...
    <div class="max-w-5xl mx-auto px-6">
      ...
      <div class="grid md:grid-cols-3 gap-8">
        ...
        <div
          ...
          <p class="text-sm text-gray-600">Start by setting up your job post with role-specific details and
            requirements.</p>
        </div>
        ...
        <div
          ...
          <p class="text-sm text-gray-600">Invite candidates for voice-based AI interviews and collect responses
            automatically.</p>
        </div>
        ...
        <div
          ...
          <p class="text-sm text-gray-600">Access performance analytics and AI-generated feedback for quick
            decision-making.</p>
        </div>
  ...
  <section id="our-clients" class="bg-white py-20 border-t border-gray-200 mb-11">
    <div class="max-w-6xl mx-auto px-6 text-center">
      ...
      <p class="text-gray-600 mb-12 max-w-2xl mx-auto text-sm md:text-base" data-aos="fade-up" data-aos-delay="100">
      ...
      <div class="grid md:grid-cols-3 gap-8">
        ...
        <!-- Testimonial 1 -->
        <div class="p-6 border rounded-xl shadow-sm hover:shadow-md transition" data-aos="zoom-in" data-aos-delay="200">
          <p class="text-gray-700 mb-4 italic">“Smart Hire completely changed the way we conduct technical interviews.
            The voice AI is shockingly effective.”</p>
          <h4 class="font-semibold text-gray-900">Sarah A.</h4>
          <span class="text-sm text-gray-500">HR Lead, TechCore</span>
        </div>

        <!-- Testimonial 2 -->
        <div class="p-6 border rounded-xl shadow-sm hover:shadow-md transition" data-aos="zoom-in" data-aos-delay="300">
          <p class="text-gray-700 mb-4 italic">“The instant evaluation reports are a lifesaver. We reduced hiring time
            by 40%.”</p>
        ...
        <!-- Testimonial 3 -->
        <div class="p-6 border rounded-xl shadow-sm hover:shadow-md transition" data-aos="zoom-in" data-aos-delay="400">
          <p class="text-gray-700 mb-4 italic">“Impressed by the AI-generated questions. It's like having an intelligent
            co-interviewer.”</p>
  ...
  <section class="bg-white py-24">
    <div class="max-w-6xl mx-auto px-6 text-center" data-aos="zoom-in" data-aos-duration="700">
