<x-app-layout>
    <!-- ✅ Background -->
    <div
        class="flex bg-gradient-to-br from-blue-100 via-blue-50 to-indigo-100 pt-8 px-4 md:px-8 pb-20 min-h-[91vh] relative">
            ...
            <main class="w-full max-w-3xl">
                ...
                <div class="text-center mt-4">
                    <div class="flex justify-center mb-4">
                        <div
                            class="w-20 h-20 bg-gradient-to-br from-green-400 to-green-600 text-white rounded-full flex items-center justify-center shadow-lg animate-bounce">
                ...
                <!-- ✅ Sexy Interview Card -->
                <div
                    class="bg-white/80 backdrop-blur-xl shadow-2xl rounded-2xl mt-12 mx-auto p-8 border border-gray-200 hover:shadow-blue-200/70 transition-all duration-300">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <span
                            class="px-3 py-1 bg-green-100 text-green-700 text-xs font-semibold rounded-full shadow-sm animate-pulse">
                            Active
                        </span>
                    </div>
                    ...
                    <div class="flex items-center gap-3 mb-10">
                        <input id="interview-link" type="text" value="{{ $interviewLink }}" readonly
                    ...
                    <!-- Toast -->
                    <div id="copy-toast"
                        class="hidden fixed top-6 right-6 bg-green-500 text-white px-4 py-2 rounded-lg shadow-lg z-50 text-sm animate-fade-in-out">
                    ...
                    <div class="flex flex-col sm:flex-row sm:gap-8 gap-4 text-gray-700 text-sm mb-10">
                        <div
                            class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border border-blue-200 shadow-sm w-fit">
                            <svg class="h-5 w-5 text-blue-600" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            <span class="font-medium text-gray-800"><strong>Duration:</strong> {{ $duration }}
                                mins</span>
                        </div>

                        <div
                            class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-50 border border-green-200 shadow-sm w-fit">
                    ...
                    <div>
                        <h5 class="text-md font-semibold text-gray-800 mb-6 flex items-center gap-2">
                            <svg class="h-5 w-5 text-blue-600" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V8H3v9a2 2 0 002 2z" />
                            </svg>
    ...
    <div id="share-modal"
        ...
        <div
            ...
            <!-- ✅ Input Field -->
            <div class="mb-4">
                <input id="share-email" type="email" placeholder="Enter candidate's email address"
