...
<body
  class="min-h-screen bg-gradient-to-br from-sky-100 via-sky-50 to-white flex items-start justify-center p-4 sm:p-6 sm:items-center">
  ...
  <article class="w-full max-w-5xl bg-white shadow-2xl rounded-2xl overflow-hidden border border-slate-200">
    ...
    <section class="grid md:grid-cols-[1.4fr,0.9fr] gap-6 p-6">
      ...
      <div>
        ...
        <div class="flex flex-wrap gap-3 mt-7">
          ...
          @isset($interview->id)
            <a href="#"
              class="inline-flex items-center gap-2 px-4 py-2 font-semibold rounded-lg bg-slate-900 text-slate-100 shadow hover:bg-slate-800 transition">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round"
                  d="M12 8c-1.657 0-3 1.567-3 3.5S10.343 15 12 15s3-1.567 3-3.5S13.657 8 12 8z" />
                <path stroke-linecap="round" stroke-linejoin="round"
                  d="M19.4 15A7.963 7.963 0 0120 12a8 8 0 10-8 8 7.963 7.963 0 003-.6" />
              </svg>
              View Summary
            </a>
          @endisset
          ...
          <a href="#"
            ...
            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round"
                d="M16 12H8m8 0l4-4m-4 4l4 4M4 6h16a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V8a2 2 0 012-2z" />
            </svg>
            Contact Support
          </a>
        </div>
    ...
    <!-- Footer -->
    <footer
      class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-1 px-6 py-4 border-t text-xs text-slate-500 bg-gradient-to-r from-slate-50 to-slate-100">
