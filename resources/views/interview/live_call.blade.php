...
<body class="bg-blue-300 min-h-screen flex flex-col text-black" data-candidate-name="{{ $userData['name'] }}"
    data-candidate-email="{{ $userData['email'] }}">


    <header
        class="bg-gradient-to-r from-blue-600/90 to-blue-500/90 shadow-lg px-4 sm:px-8 py-2 flex flex-col sm:flex-row justify-between items-start sm:items-center rounded-b-3xl border-b border-white/25">
        <div>
            <h1 class="text-2xl sm:text-4xl font-extrabold text-white drop-shadow-md tracking-wide">
            ...
            <p class="text-md sm:text-lg text-white/90 mt-2">
                Candidate: <span class="font-semibold">{{ $userData['name'] }}</span> — <span
                    class="italic">{{ $userData['email'] }}</span>
            </p>
        </div>
    ...
    <main class="flex-1 flex flex-col lg:flex-row p-3 sm:p-6 gap-6">

        <!-- Left: Video/Call Area -->
        <section
            class="flex-1 bg-white/80 backdrop-blur-lg rounded-2xl shadow-lg p-4 sm:p-8 flex flex-col items-center text-center border border-gray-300 relative">
            <!-- Timer -->
            <div class="absolute top-2 right-3 bg-black/80 text-white text-sm px-3 py-1 rounded-full shadow"
                id="timer1">
                00:00
            </div>

            <!-- Top 2 cards -->
            <div class="flex flex-col sm:flex-row gap-4 sm:gap-16 mb-8 w-full justify-center">
                <!-- Card 1 -->
                <div
                    class="bg-white/90 rounded-lg shadow-lg p-4 sm:p-8 w-full sm:w-[300px] md:w-[420px] h-48 sm:h-60 flex flex-col items-center justify-center border border-gray-200">
                    <img id="ai-photo" src="{{ asset('lego.avif') }}"
                        class="w-28 h-32 rounded-full  shadow-md object-cover object-center" alt="Profile 1">
                ...
                <div
                    ...
                    <img id="candidate-photo" src="{{ asset('person.png') }}"
                        class="w-28 h-32 rounded-full shadow-md object-cover object-center" alt="Profile 2">
            ...
            <div id="live-transcript"
                class="mt-4 sm:mt-6 w-full max-w-2xl bg-white p-3 sm:p-4 rounded-lg shadow-inner border border-gray-200 text-left">
            ...
            <div class="mt-6 sm:mt-8 flex gap-6 sm:gap-8">
                <button id="end-call-btn" class="p-4 bg-red-500 text-black rounded-full shadow-md hover:bg-red-600"> 📞
                </button>
